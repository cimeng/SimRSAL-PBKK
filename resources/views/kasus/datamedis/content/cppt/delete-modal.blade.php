<div class="modal fade" id="cpptModalDelete" tabindex="-1" role="dialog" aria-labelledby="modal-fromright" aria-hidden="true">
        ...
        <div class="modal-content">
            <div class="block rounded block-transparent mb-0">
                ...
                <div class="block-content">
                    <form class="js-validation-be-contact" action="{{url('kasus')}}/{{ $nomor_kasus }}/datamedis/cppt/delete" method="post">
                        {{ csrf_field() }}

                        <input type="hidden" class="form-control form-control-lg" id="cppt-delete-id" name="id" placeholder=""></textarea>
                        <h5 class="font-w400">
                        ...
                        <div class="form-group row">
                            <div class="col-12">
                                ...
                                <button type="submit" class="btn-alt btn-hero btn-primary min-width-100 float-right">
                                    <i class="fa fa-send mr-5"></i> Hapus CPPT
                                </button>
                            </div>
                        </div>
